...
| 2. Каркас UI по макетам | Токены Kinetic Torrent + 4 экрана-заглушки + навигация (sidebar/bottom); сборка macOS и iOS | Каркас для результатов 1, 2, 5 | принять (после merge MR) | Соответствует issue #2 |
